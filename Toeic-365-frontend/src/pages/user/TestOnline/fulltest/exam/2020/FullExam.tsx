...
function FullExam() {
    const partOneRef = useRef<HTMLHeadingElement>(null);
    const partTwoRef = useRef<HTMLHeadingElement>(null);
    const partThreeRef = useRef<HTMLHeadingElement>(null);
    const partFourRef = useRef<HTMLHeadingElement>(null);
    ...
    const viewDetailsAndScroll = (ref: any) => {
        if (ref && ref.current) {
            ref.current.scrollIntoView({ behavior: "smooth" });
        }

        // Call the original viewDetails function if needed
        viewDetails();
    };
                                    ...
                                    <div className="question-content">
                                        <form method="post" acceptCharset="utf-8" action="" id="submitForm">
                                            ...
                                            {exam && exam.part.length && exam.part[0] ? <>
                                                <h4 className="sm" ref={partOneRef}
                                                ...
                                                {exam && exam.part.length && exam.part[0].groupQuestion[0].question.map((element: any, index: number) => {
                                            ...
                                            {exam && exam.part.length && exam.part[1] ? <>
                                                <hr />
                                                <h4 className="sm" ref={partTwoRef}>{exam.part[1].partName}</h4>
                                                <p className="text-justify"
                                            ...
                                            {exam && exam.part.length && exam.part[2] ? <>
                                                <hr />
                                                <h4 className="sm" ref={partThreeRef}>{exam.part[2].partName}</h4>
                                                <p className="text-justify"
                                                ...
                                                {exam && exam.part.length && exam.part[2].groupQuestion[0].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[2].groupQuestion[1].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[2].groupQuestion[2].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[2].groupQuestion[3].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[2].groupQuestion[4].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[2].groupQuestion[5].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[2].groupQuestion[6].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                            ...
                                            {exam && exam.part.length && exam.part[3] ? <>
                                                <hr />
                                                <h4 className="sm" ref={partFourRef}>{exam.part[3].partName}</h4>
                                                <p className="text-justify"
                                                ...
                                                {exam && exam.part.length && exam.part[3].groupQuestion[0].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[3].groupQuestion[1].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[3].groupQuestion[2].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[3].groupQuestion[3].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[3].groupQuestion[4].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                            ...
                                            {exam && exam.part.length && exam.part[4] ? <>
                                                ...
                                                {exam && exam.part.length && exam.part[4].groupQuestion[0].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                            ...
                                            {exam && exam.part.length && exam.part[5] ? <>
                                                ...
                                                {exam && exam.part.length && exam.part[5].groupQuestion[0].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[5].groupQuestion[1].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                            ...
                                            {exam && exam.part.length && exam.part[6] ? <>
                                                ...
                                                {exam && exam.part.length && exam.part[6].groupQuestion[0].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[6].groupQuestion[1].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
                                                ...
                                                {exam && exam.part.length && exam.part[6].groupQuestion[2].question.map((element: any, index: number) => {
                                                    const collapseId = `collapse-${element.questionNumber}-${index}`;
                                                    const accordionId = `accordion-${element.questionNumber}-${index}`;
                                                    return (
                                                        <div key={element.questionNumber}>
